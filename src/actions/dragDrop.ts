...
export default function createDragDropActions<Context>(
	...
	return {
		beginDrag(
			...
			const sourceIds = sourceOptions.map(option => option.sourceId);
			...
			const itemOption = sourceOptions.find(option => option.sourceId === sourceId)
